...
Welcome to the central documentation repository. This documentation site dynamically pulls content from multiple repositories:

- **Engineering Repository**: Contains API documentation, architecture guides, and technical specifications
- **Operations Repository**: Contains deployment guides, monitoring documentation, and operational procedures

## Overview

This documentation is built using [MkDocs](https://www.mkdocs.org/) with the Material theme and is automatically published via GitHub Actions.
